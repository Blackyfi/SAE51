...
// Requête InfluxDB pour récupérer les 20 dernières entrées de température et d'humidité dans la pièce 'chambre'
$query = "SELECT time, temp, hum FROM Mesure WHERE piece = 'chambre' ORDER BY time DESC LIMIT 20;";
...
$htmlOutput .= '<table>';        
$htmlOutput .= '<caption>Chambre</caption>';
