...
// Requête InfluxDB pour récupérer les 20 dernières entrées de température et d'humidité dans la pièce 'sdr'
$query = "SELECT time, temp, hum FROM Mesure WHERE piece = 'sdr' ORDER BY time DESC LIMIT 20;";
...
$htmlOutput .= '<table>';        
$htmlOutput .= '<caption>Salle de Réunion</caption>';
