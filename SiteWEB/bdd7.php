...
// Création d'une instance de Guzzle pour l'utilisation avec InfluxDB
...
// Requête InfluxDB pour récupérer la colonne 'gain' de la mesure 'Anal'
$query = "SELECT gain FROM Anal";
...
$htmlOutput .= '<table>';        
$htmlOutput .= '<caption>Salle de Reunion</caption>';
