...
// Requête InfluxDB pour récupérer les 20 dernières entrées de température et d'humidité dans la pièce 'cuisine'
$query = "SELECT time, temp, hum FROM Mesure WHERE piece = 'cuisine' ORDER BY time DESC LIMIT 20;";
...
$htmlOutput .= '<table>';        
$htmlOutput .= '<caption>Cuisine</caption>';
