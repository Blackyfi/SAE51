...
// Requête InfluxDB pour récupérer les 20 dernières entrées de température et d'humidité dans la pièce 'salon'
$query = "SELECT time, temp, hum FROM Mesure WHERE piece = 'salon' ORDER BY time DESC LIMIT 20;";
...
$htmlOutput .= '<table>';        
$htmlOutput .= '<caption>Salon</caption>';
